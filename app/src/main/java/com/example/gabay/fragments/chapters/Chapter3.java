...
public class Chapter3 extends Fragment {
        ...
        if (requestCode == LESSON_ACTIVITY_REQUEST && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                if (completedLevel != -1 && levelCompleted) {
                    ...
                    if (progressViewModel.shouldTakeQuiz(3, completedLevel)) {
    ...
    private boolean isChapterCompleted() {
        int completedLevels = progressViewModel.getChapterProgress(3);
    ...
    public void markLevelAsFinished(int level, int score) {
        ...
        if (progressViewModel != null) {
            progressViewModel.updateChapterProgress(3, level);
        }
    ...
    private void updateUserAchievements(int level) {
        ...
        if (profile != null) {
            ProgressViewModel.ChapterProgress chapterProgress = progressViewModel.getChapterProgressObject(3);
            ...
            if (level % 5 == 0) {
                ...
                progressViewModel.markQuizCompleted(3, level);
            }
    ...
    private void resetChapterProgress() {
        ...
        editor.apply();
        if (progressViewModel != null) {
            progressViewModel.resetChapterProgress(3);
        }
        updateLevelStates();
