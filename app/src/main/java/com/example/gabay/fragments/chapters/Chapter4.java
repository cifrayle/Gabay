...
//        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == LESSON_ACTIVITY_REQUEST && resultCode == RESULT_OK) {
            ...
            Log.d("Chapter4", "Quiz activity returned, refreshing UI");
            if (progressViewModel != null) {
    ...
    private void checkChapterCompletion() {
        ...
        if (progress != null && progress.getProgressPercentage() >= 100) {
            Toast.makeText(requireContext(), "Congratulations! Chapter 4 completed! Quiz unlocked!", Toast.LENGTH_LONG).show();
    ...
    private void updateQuizButtonState() {
        ...
        Log.d("QuizDebug", "Chapter 4 - Completed: " + isChapterDone + ", Quiz Done: " + isQuizDone);
        Log.d("QuizDebug", "Chapter 4 Progress: " + progressViewModel.getChapterProgress(4) + "/" + progressViewModel.getMaxLevelsForChapter(4));
    ...
    public void onResume() {
        ...
        if (progressViewModel != null) {
            ...
            if (progressViewModel.getChapterProgress(4) == 0) {
                Log.d("Chapter4", "No progress data found, refreshing from database");
                progressViewModel.refreshProgressFromSupabase();
            } else {
                Log.d("Chapter4", "Using existing progress data to avoid overwriting quiz states");
            }
        ...
        Log.d("Chapter4", "Chapter4 resumed - updating UI without data overwrite");
    }
